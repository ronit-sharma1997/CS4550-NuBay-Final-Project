...
editingPhoto: prevState.images.length == 0 ? URL.createObjectURL(event.target.files[0])
 ...
 render() {
    ...
    <div className="container mt-2 top-border">
        <div className="row">
         ...
         <div className="form-group col-12">
                                     ...
                                     <label htmlFor="payment-options" className="col-form-label float-left">
     ...
     <div className="container mt-2 top-border">
     <div className="row mb-0 border-bottom">
                     <div className="col-8">
                         <h4> Categories </h4>
    ...
    <div className="col-8 border-bottom">
        ...
        <div className="col-8">
        <span> Add up to 4 photos of your product </span>
        </div>
    </div>
        <div className="row mt-2 w-100 justify-content-center">
        <ImageGrid className="w-100" images={this.state.images} onDrop={this.fileSelectedHandler}
        editingImage={this.state.editingPhoto}
        renderGrid={this.renderGrid}/>
        </div>
    </div>
   <div className="container mt-2 mb-2">
    <div className="row">
        <button type="button" className=" ml-2 btn btn-success btn">List Item</button>
